...
| 3 | 🔵 **Guided custom-prompt UI** — show "test these niches you can own" suggestions + a 1-click add; reframe the box from passive to guided (elicit the merchant's specific differentiators) | portal | 🔵 built, PR open | #84 (awaiting merge/deploy) |
