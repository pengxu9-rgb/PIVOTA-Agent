...
test('travelAlertsProvider: buildAlertsFromPayload dedupes duplicate windows and annotates non-local summary', () => {
  const warningFull = {
    ...
    timelaps: [
      ...
      {
        phenomenon_id: '7',
        timelaps_items: [{ begin_time: 1700001005, end_time: 1700004605 }],
      },
    ],
    phenomenons_items: [
...
test('travelAlertsProvider: keeps only one non-local alert when multiple windows exist', () => {
  const warningFull = {
    comments: { text: ['Crues importantes en cours sur la Charente et la Loire aval.'] },
    end_validity_time: 1700015000,
    update_time: 1700000000,
    timelaps: [
      {
        phenomenon_id: '2',
      ...
      {
        phenomenon_id: '7',
        timelaps_items: [{ begin_time: 1700008200, end_time: 1700011800 }],
      },
    ],
    phenomenons_items: [
      { phenomenon_id: '2', phenomenon_max_color_id: 3 },
