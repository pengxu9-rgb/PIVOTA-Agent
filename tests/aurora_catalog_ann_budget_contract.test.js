...
describe('aurora catalog_ann budget contract', () => {
  const prevEnv = {
    ...
    AURORA_BFF_PRODUCT_URL_COMPETITOR_MAIN_RESOLVE_FALLBACK: process.env.AURORA_BFF_PRODUCT_URL_COMPETITOR_MAIN_RESOLVE_FALLBACK,
    AURORA_BFF_RECO_COMPETITOR_MAIN_QUERY_FANOUT_CAP: process.env.AURORA_BFF_RECO_COMPETITOR_MAIN_QUERY_FANOUT_CAP,
    AURORA_BFF_RECO_COMPETITOR_MAIN_QUERY_MIN_BUDGET_MS: process.env.AURORA_BFF_RECO_COMPETITOR_MAIN_QUERY_MIN_BUDGET_MS,
    AURORA_BFF_RECO_COMPETITOR_MAIN_TIMEOUT_FLOOR_MS: process.env.AURORA_BFF_RECO_COMPETITOR_MAIN_TIMEOUT_FLOOR_MS,
