const STATIC_BRAND_ALIASES = Object.freeze({
  ...
  pixi_beauty: ['pixi beauty', 'pixibeauty', 'pixi'],
  moroccanoil: ['moroccanoil', 'moroccan oil'],
  gisou: ['gisou'],
  biologique_recherche: ['biologique recherche', 'biologiquerecherche'],
  nuxe: ['nuxe'],
  jurlique: ['jurlique'],
  pattern_beauty: ['pattern beauty', 'patternbeauty'],
  jvn: ['jvn'],
  fable_and_mane: ['fable and mane', 'fable & mane', 'fableandmane'],
  living_proof: ['living proof', 'livingproof'],
  r_and_co: ['r+co', 'r co', 'randco'],
  dae: ['dae'],
  ilia: ['ilia'],
  kosas: ['kosas'],
