...
const OfferObjectV0Schema = z.discriminatedUnion('source', [ExternalOfferV0Schema, InternalOfferV0Schema]);

module.exports = {
  ExternalOfferV0Schema,
  InternalOfferV0Schema,
  OfferObjectV0Schema,
};
