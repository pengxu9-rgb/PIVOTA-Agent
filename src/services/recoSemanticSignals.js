...
const STRONG_CATEGORY_VERTICAL_OVERRIDES = [
  ...
  ['haircare', /\b(hair care|haircare|shampoo|conditioner|deep conditioner|hair oil|hair mask|scalp|scalp care|scalp treatment|scalp tonic|scalp oil|styling cream|styling gel|leave in|leave-in|detangling|repair)\b/i],
...
function inferVerticalFromProduct(product) {
  ...
  const ordered = Object.entries(scores).sort((a, b) => {
    ...
    const priority = ['fragrance', 'skincare', 'haircare', 'bodycare', 'makeup', 'tools'];
