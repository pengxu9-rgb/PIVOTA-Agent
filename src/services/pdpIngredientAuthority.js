...
const INCI_STRUCTURE_RE =
  /\b(aqua|water|extract|oil|acid|glycol|glycerin|alcohol|amide|amine|ceramide|panthenol|niacinamide|tocopherol|hyaluronate|triglyceride|dimethicone|siloxane|ferment|butter|wax|seed|leaf|root|flower|fruit|sodium|potassium|chloride|oxide|dioxide|hydroxide|carbomer|cellulose|poly|polyisobutene|copolymer|pectin|capry|propanediol|butylene|ethylene|hexanediol|ethanol|glucoside|benzoate|sorbate|retinal|retinol|caffeine|bisabolol|arginine|ergothioneine|isododecane|isostearate|stearate|cinnamate|salicylate|citronellal|ketones?|parfum|limonene|linalool|geraniol|citral|citronellol|eugenol|farnesol)\b|peptide/i;
