...
function buildExternalSeedHarvesterCandidates(row, options = {}) {
  ...
  const productLevelIngredientText =
    normalizeNonEmptyString(snapshot.ingredients_raw) ||
    normalizeNonEmptyString(seedData.ingredients_raw) ||
    extractRawIngredientText(snapshot.description_raw) ||
    extractRawIngredientText(seedData.description_raw) ||
