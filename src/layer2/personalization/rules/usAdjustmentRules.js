...
const { getIntentSelection } = require('../../dicts/intentSelection');
...
function techniqueIdsForIntent(intentId, input) {
...
const US_ADJUSTMENT_FALLBACK_RULES = {
  ...
  lip: {
    ...
    build: (ctx) => ({
      ...
      ...doActionSpecForIntent('LIP_FALLBACK_FINISH_FOCUS_MICRO', { market: 'US', preferenceMode: ctx.preferenceMode }),
      doActions: [],
