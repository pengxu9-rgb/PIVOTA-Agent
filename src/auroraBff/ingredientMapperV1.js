...
const INGREDIENT_DISCOVERY_HINTS = Object.freeze({
  ceramide_np: {
    ...
    steps: [
      ['ceramide barrier moisturizer', 'strong_exact'],
      ['ceramide moisturizer', 'strong_alias'],
  ...
  panthenol: {
    ...
    steps: [
      ['panthenol repair serum', 'strong_exact'],
      ['provitamin b5 repair serum', 'strong_alias'],
  ...
  glycerin: {
    ...
    semantic_family: 'moisturizer',
    steps: [
      ['glycerin moisturizer', 'strong_exact'],
      ['glycerine cream', 'strong_alias'],
  ...
  hyaluronic_acid: {
    ...
    semantic_family: 'serum',
    steps: [
      ['hyaluronic acid serum', 'strong_exact'],
      ['sodium hyaluronate serum', 'strong_alias'],
  ...
  niacinamide: {
    ...
    semantic_family: 'serum',
    steps: [
      ['niacinamide serum', 'strong_exact'],
      ['vitamin b3 serum', 'strong_alias'],
  ...
  zinc_pca: {
    ...
    semantic_family: 'serum',
    steps: [
      ['zinc pca serum', 'strong_exact'],
      ['zinc serum', 'strong_alias'],
      ['balancing serum', 'supportive_family'],
      ['daily treatment serum', 'generic_family'],
    ],
  },
  azelaic_acid: {
    ...
    semantic_family: 'serum',
    steps: [
      ['azelaic acid cream', 'strong_exact'],
      ['azelaic cream', 'strong_alias'],
      ['soothing treatment cream', 'supportive_family'],
      ['daily treatment cream', 'generic_family'],
    ],
  },
  salicylic_acid: {
    target_step_family: 'serum',
    semantic_family: 'serum',
    steps: [
      ['salicylic acid serum', 'strong_exact'],
      ['bha lotion', 'strong_alias'],
  ...
  ascorbic_acid: {
    ...
    semantic_family: 'serum',
    steps: [
      ['ascorbic acid serum', 'strong_exact'],
      ['vitamin c serum', 'strong_alias'],
  ...
  retinol: {
    ...
    steps: [
      ['retinol emulsion', 'strong_exact'],
      ['night retinol emulsion', 'strong_alias'],
      ['retinoid night treatment', 'supportive_family'],
      ['night treatment emulsion', 'generic_family'],
    ],
  },
  benzoyl_peroxide: {
    target_step_family: 'treatment',
    semantic_family: 'treatment',
    steps: [
      ['benzoyl peroxide gel', 'strong_exact'],
      ['bpo spot gel', 'strong_alias'],
      ['blemish spot treatment', 'supportive_family'],
      ['acne spot treatment', 'generic_family'],
    ],
  },
  sunscreen_filters: {
    ...
    steps: [
      ['broad spectrum sunscreen', 'strong_exact'],
      ['spf 50 sunscreen', 'strong_alias'],
