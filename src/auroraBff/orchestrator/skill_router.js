...
const IngredientHubSkill = require('../skills/ingredient_hub');
...
const SKILL_MAP = Object.freeze({
  ...
  'ingredient.hub': IngredientHubSkill,
...
const ENTRY_SOURCE_TO_SKILL = Object.freeze({
  ...
  'chip.start.travel': 'travel.apply_mode',
  'chip_start_travel': 'travel.apply_mode',
  'chip.start.ingredients.entry': 'ingredient.hub',
  'chip_start_ingredients_entry': 'ingredient.hub',
  'chip.start.ingredients': 'ingredient.hub',
  'chip_start_ingredients': 'ingredient.hub',
