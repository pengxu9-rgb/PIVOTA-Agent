...
const GUIDANCE_FASTPATH_INTERNAL_RECALL_BUDGET_MS = 1400;
const GUIDANCE_FASTPATH_EXTERNAL_RECALL_BUDGET_MS = 1400;
const GUIDANCE_FASTPATH_SUPPORTIVE_ATTEMPT_BUDGET_MS = 1000;
