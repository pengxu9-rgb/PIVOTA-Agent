...
assert_card_any "product_chat" "returns_product_result_card" "product_verdict,product_analysis"
...
assert_card_any "dupe_suggest_chat" "returns_dupe_suggest_card" "dupe_suggest,product_verdict"
...
assert_card_any "dupe_compare_chat" "returns_dupe_compare_card" "compatibility,dupe_compare"
