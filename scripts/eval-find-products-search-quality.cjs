...
const DEFAULT_CASES = Object.freeze([
  ...
  { id: 'brand_cat_rare_blush', group: 'brand_category', query: 'rare beauty blush', expected_contract: { query_class: 'brand_category', target_domain: 'beauty' }, allowed_brands: ['rare beauty'], allowed_category_prefixes: ['beauty/makeup/cheek'], min_result_count: 1, require_image: true, require_valid_price: true, require_pdp_open: true },
