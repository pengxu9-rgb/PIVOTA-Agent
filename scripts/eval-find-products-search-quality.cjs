...
const DEFAULT_CASES = Object.freeze([
  ...
  { id: 'exact_rare_positive_light_tinted_moisturizer', group: 'exact_product', query: 'rare beauty positive light tinted moisturizer', expected_contract: { query_class: 'exact_product', target_domain: 'beauty' }, allowed_brands: ['rare beauty'], forbidden_terms: ['blush', 'dog toy', 'gift card'], min_result_count: 1, max_product_line_repeats: 1, require_image: true, require_valid_price: true, require_pdp_open: true },
