...
# Attach X-Internal-Key to gateway requests (PIVOTA-Agent #2038). Sourced AFTER the base is set,
# because the wrapper scopes the header to that host. No-op until AURORA_SURFACE_INTERNAL_KEY is set.
