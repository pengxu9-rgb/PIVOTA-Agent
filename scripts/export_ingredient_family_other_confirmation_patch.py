#!/usr/bin/env python3
"""Export review-notes patch rows from an ingredient-family-other decision packet."""
...
CONFIRM = "confirm_ingredient_family_other"
KEEP_OPEN = "keep_open"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Export review-notes patch rows from an ingredient-family-other decision packet.")
    parser.add_argument("--decision-csv", required=True, help="Reviewed ingredient-family-other decision packet CSV")
            ...
            apply_rows.append(
                {
                    ...
                    "proposal_sources": "ingredient_family_other_confirmation",
