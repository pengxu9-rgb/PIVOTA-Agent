...
Generated: 2026-05-28T10:11:38.126Z

Scope: active external seeds, market=US, include_attached=true, limit=500

Report directory: /private/tmp/pivota-agent-product-intel-tail-20260528/reports/markato_expansion_status_20260524/wave48_product_intel_tail_20260528/changed_post_audit
...
- Direct KB high-quality-ready rows: 84
...
```json
{
  ...
  "pivota_insights": {
    ...
    "effective_issues": [
      {
        "key": "public_promo_availability_copy",
        "count": 1
      }
    ],
    "effective_issue_domains": [
      {
        "key": "tirtir.global::public_promo_availability_copy",
        "count": 1
      }
    ],
    "quality_state": [
    ...
    "samples": {
      "public_promo_availability_copy": [
        {
          "external_product_id": "ext_13d1e7bc87a49618d8283bc5",
          "domain": "tirtir.global",
          "title": "Centella Foam Cleansing",
          "used_product_id": "ext_13d1e7bc87a49618d8283bc5",
