...
Generated: 2026-05-28T10:55:12.939Z

Scope: active external seeds, market=US, domain=theinkeylist.com, include_attached=true, limit=500

Report directory: /private/tmp/pivota-agent-product-intel-tail-20260528/reports/markato_expansion_status_20260524/wave48_product_intel_tail_20260528/theinkeylist_domain_audit_after
...
- DB Serving Ready rows: 3 (0.3333)
- DB Serving Ready rows excluding terminal holds: 3 (0.3333)
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| theinkeylist.com | 9 | 0 | 3 | 0.3333 | 0.3333 | 0 | kb_blocked |
