...
- run_id: 20260211_062941
- generated_at: 2026-02-11T06:29:50.306Z
- mode: local
- datasets: fasseg
...
- module_mIoU_mean: 0.075
- leakage_non_skin_mean: 0.824
- leakage_bg_mean: 0.063
...
- leakage_non_skin_mean 0.824 > observation 0.1
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| fasseg | segmentation_only | chin | 150 | 0.005 | 0 | 0.016 | 0.125 | 0.992 | 0.064 | 0.001 | 988 | 0 | 0 |
| fasseg | segmentation_only | forehead | 150 | 0.057 | 0.061 | 0.128 | 0.165 | 0.918 | 0.11 | 0.012 | 374 | 0 | 0 |
...
| fasseg | segmentation_only | under_eye_left | 143 | 0.072 | 0.055 | 0.164 | 0.968 | 0.927 | 0.034 | 0.007 | 1356 | 0 | 0 |
| fasseg | segmentation_only | under_eye_right | 142 | 0.055 | 0.036 | 0.128 | 0.956 | 0.945 | 0.035 | 0.006 | 1356 | 0 | 0 |

## Artifacts

- jsonl: `reports/eval_circle_20260211_062941.jsonl`
- csv: `reports/eval_circle_summary_20260211_062941.csv`
