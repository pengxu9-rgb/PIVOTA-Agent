...
- run_id: 20260211_062811
- generated_at: 2026-02-11T06:28:20.079Z
- mode: local
- datasets: fasseg
...
- circle_model_excluded_modules: nose, under_eye_left, under_eye_right
...
- leakage_non_skin_mean: 0.848
- leakage_bg_mean: 0.047
...
- leakage_non_skin_mean 0.848 > observation 0.1
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| fasseg | segmentation_only | chin | 150 | 0.005 | 0 | 0.016 | 0.125 | 0.989 | 0.084 | 0.001 | 204 | 0 | 0 |
...
| fasseg | segmentation_only | nose | 149 | 0.249 | 0.231 | 0.275 | 0.335 | 0.143 | 0.117 | 0.009 | 700 | 0 | 0 |
...
- jsonl: `reports/eval_circle_20260211_062811.jsonl`
- csv: `reports/eval_circle_summary_20260211_062811.csv`
